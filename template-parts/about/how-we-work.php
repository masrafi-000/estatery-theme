...
<section class="py-14 bg-[#fcfcfc] overflow-hidden js-how-we-work">
    <div class="container mx-auto px-6 lg:px-12">
        ...
        <div class="max-w-3xl mb-16 lg:mb-24 js-process-header js-reveal-stagger">
            <div class="inline-flex items-center gap-2.5 px-4 py-2 border border-black/20 mb-8 js-reveal-fade">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 relative js-process-grid js-reveal-stagger">
            ...
            <?php foreach ($how_we_work['steps'] as $index => $step): ?>
                <div class="js-process-step relative z-10 group p-8 rounded-xl bg-white border border-primary/5 hover:border-primary/20 hover:shadow-xl hover:shadow-primary/5 transition-[border-color,box-shadow] duration-500 js-reveal-fade">
