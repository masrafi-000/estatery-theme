...
<section class="relative py-24 bg-white overflow-hidden js-leadership-section">
    ...
    <div class="container mx-auto px-6 lg:px-12 relative z-10">
        <div class="flex flex-col lg:flex-row items-center gap-12 lg:gap-0">
            ...
            <div class="w-full lg:w-5/12 relative group js-leadership-image js-reveal-fade">
                ...
                <div class="relative z-10 rounded-sm overflow-hidden shadow-2xl bg-primary">
                    <img src="<?php echo get_template_directory_uri(); ?>/public/images/about.jpg"
                        ...
                        class="w-full h-[550px] object-cover transition-transform duration-1000 scale-110 group-hover:scale-100">
                </div>

                <div class="absolute -bottom-10 -left-6 lg:left-[-10%] bg-white p-6 shadow-xl z-20 hidden md:block border-l-4 border-black js-leadership-card js-reveal-fade">
            ...
            <div class="w-full lg:w-7/12 lg:pl-24 space-y-8 js-leadership-content js-reveal-stagger">
                <div class="space-y-4">
                    <div class="inline-flex items-center gap-2 px-3 py-1 bg-black/5 rounded-full js-reveal-fade">
                    ...
                    <h2 class="text-4xl md:text-5xl font-extrabold text-secondary tracking-tight leading-[1.1] js-reveal-text">
                        <?php echo $leadership['title']; ?>
                    </h2>
                </div>

                <div class="relative js-reveal-fade">
