...
<article class="group bg-white border border-slate-100 overflow-hidden rounded-3xl hover:shadow-[0_30px_60px_-15px_rgba(0,0,0,0.1)] transition-all duration-500 flex flex-col h-full" data-aos="fade-up">
    ...
    <div class="relative h-64 overflow-hidden">
        ...
        <?php else : ?>
            <img src="https://images.pexels.com/photos/1643383/pexels-photo-1643383.jpeg?auto=compress&cs=tinysrgb&w=800" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-[1.5s]">
        <?php endif; ?>
    ...
    <div class="p-8 flex flex-col flex-1">
        <div class="flex items-center gap-2 mb-4">
            ...
            <span class="text-slate-400 text-[11px] font-medium uppercase tracking-widest"><?php echo $read_time; ?> Min Read</span>
        </div>
        ...
        <div class="mt-auto pt-6 border-t border-slate-50 flex items-center justify-between">
            ...
            <a href="<?php the_permalink(); ?>" class="size-11 rounded-2xl bg-slate-900 text-white flex items-center justify-center hover:bg-primary transition-all duration-300 shadow-lg shadow-slate-900/10 group-hover:scale-105">
